/**  
* @Title: BankAccountWithSyncBlock.java
* @Package com.daiinfo.javaadvanced.know6.training
* @Description: TODO(用一句话描述该文件做什么)
* @Copyright: Copyright (c) 2019-2021
* @company www.daiinfo.net
* @author 戴远泉  
* @date 2020年11月12日 上午11:38:50
* @version V1.0  
*/
...
/**
* @ClassName: BankAccountWithSyncBlock
* @Description: TODO(这里用一句话描述这个类的作用)
* @author 戴远泉
* @date 2020年11月12日上午11:38:50
*/

public class BankAccountWithSyncBlock {
	int id;// 账号
	double balance;// 余额
	 ...
	 */
	public BankAccountWithSyncBlock() {
	 ...
	 * 
	  ...
	  * @param balance
	 */
	public BankAccountWithSyncBlock(int id, double balance) {
		this.id = id;
